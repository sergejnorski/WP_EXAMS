    ...
    public SecurityFilterChain securityFilterChain(HttpSecurity http) throws Exception  {
        http.csrf(AbstractHttpConfigurer::disable)
                .authorizeHttpRequests( (requests) -> requests
                        ...
                        .requestMatchers(AntPathRequestMatcher.antMatcher("/candidates/*/vote")).hasRole("USER")
                        .requestMatchers(AntPathRequestMatcher.antMatcher("/candidates/**")).hasRole("ADMIN")
                        .anyRequest()
                        .authenticated()
                )
                .formLogin((form) -> form
